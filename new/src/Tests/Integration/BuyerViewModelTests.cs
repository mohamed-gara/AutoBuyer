...
namespace Tests.Integration
{
    public class BuyerViewModelTests : Tests
    {
        ...
        {
            var connectionMock = Mock<IStockItemConnection>();

            BuyerViewModel("ItemId", 10, 1, "Buyer",
                connectionMock.Object, BuyerRepository(ConnectionString));
        ...
        {
            var connectionMock = Mock<IStockItemConnection>();
            BuyerViewModel("ItemId", 10, 1, "Buyer", connectionMock.Object,
                BuyerRepository(ConnectionString));
